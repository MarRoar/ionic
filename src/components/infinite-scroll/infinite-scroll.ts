 ...
 *  </ion-list>
 *
 *  <ion-infinite-scroll (infiniteScrollLoading)="doInfinite($event)">
...
export class InfiniteScroll {
   ...
   */
  @Output() infiniteScrollLoading: EventEmitter<InfiniteScroll> = new EventEmitter();
  ...
  private _onScroll(ev) {
    ...
    if (distanceFromInfinite < 0) {
      this._zone.run(() => {
        ...
        this.infiniteScrollLoading.emit(this);
      });
      return 5;
    }
