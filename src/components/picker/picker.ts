...
export class Picker extends ViewController {
  ...
  @Output() pickerChange: EventEmitter<any>;
...
class PickerColumnCmp {
  ...
  rotateFactor: number;
  lastIndex: number;
  @Output() pickerChange: EventEmitter<any> = new EventEmitter();
  ...
  update(y: number, duration: number, saveY: boolean, emitChange: boolean) {
    ...
    if (emitChange) {
      if (this.lastIndex === undefined) {
        ...
        this.lastIndex = this.col.selectedIndex;
        this.pickerChange.emit(this.col.options[this.col.selectedIndex]);
      }
    }
  }
  ...
  template:
    ...
    '<div class="picker-wrapper">' +
      ...
      '<div class="picker-columns">' +
        ...
        '<div *ngFor="let c of d.columns" [col]="c" class="picker-col"> (pickerChange)="_colChange($event)"</div>' +
...
class PickerDisplayCmp {
  ...
  private _colChange(selectedOption: PickerColumnOption) {
    ...
    picker.pickerChange.emit(this.getSelected());
  }
